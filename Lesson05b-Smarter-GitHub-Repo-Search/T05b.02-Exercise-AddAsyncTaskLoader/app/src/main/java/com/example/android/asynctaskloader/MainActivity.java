...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 66;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubSearchLoader == null) {
            Log.d(TAG, "makeGithubSearchQuery - initLoader");
            loaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        } else {
            Log.d(TAG, "makeGithubSearchQuery - restartLoader");
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                if (args == null) {
                    Log.d(TAG, "onStartLoading - bad args");
                    return;
                }

                Log.d(TAG, "onStartLoading - good args");
